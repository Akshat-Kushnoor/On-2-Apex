        ...
        <div className="w-full max-w-md space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-neutral-600">
              Initialize your verified profile and start matching top engineering roles.
            </p>
          </div>
          ...
          <Card className="border-2 border-black bg-white shadow-[6px_6px_0px_#000]">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Fast-track onboarding with social login or email.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span>{socialLoading === "google" ? "Creating..." : "Google"}</span>
                </Button>
                ...
                >
                  ...
                  <span>{socialLoading === "github" ? "Creating..." : "GitHub"}</span>
                </Button>
              </div>
